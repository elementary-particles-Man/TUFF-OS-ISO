...
| "TuffHandoffBlock V2 checksum error" | Handoff from UEFI to Kernel failed | 1. Power off → Reboot.<br>2. If it persists, perform a repair install from the USB. | Designed with auto-rollback for power cuts. |
